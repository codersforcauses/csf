...
class MileageTests(APITestCase):
    ...
    def test_leaderboard(self):
        ...
        self.assertEquals(response.data["leaderboard"], [{'username': 'user3', 'total_mileage': 6.0},
                                                        {'username': 'user1', 'total_mileage': 5.0},
                                                        {'username': 'user2', 'total_mileage': 4.0},
                                                        {'username': 'Fred', 'total_mileage': 0.0}])
        ...
        self.assertEquals(response.data["leaderboard"], [{'name': 'team1', 'bio': 'we are team 1', 'total_mileage': 9.0},
